...
#pragma region Texture Stuff
	...
	Texture2DData::sptr particleMap = Texture2DData::LoadFromFile("Textures/Particle.png");
	...
	Texture2D::sptr diffusePart = Texture2D::Create();
	diffusePart->LoadData(particleMap);
